...
class VectorDB:
    def __init__(self):
        ...
        self.reranker = CrossEncoder('cross-encoder/ms-marco-MiniLM-L-6-v2')  # loaded once now
    ...
    def retrieve(self, query: str, namespace: str, top_k: int = 10) -> list:
        ...
        # Step 3: Cross-encoder rank — reuses self.reranker, no reload
        scores = self.reranker.predict([(query, c['text']) for c in filtered_chunks])
